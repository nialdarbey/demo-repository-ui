...
!function($){
    ...
    var Typeahead = function (element, options) {
        ...
        this.autoUpdate = this.options.autoUpdate || false
    ...
    Typeahead.prototype = {
        ...
        , move: function (e) {
            ...
            switch(e.keyCode) {
                case 9: // tab
                case 13: // enter
                    if (this.$menu.find('.search-results').length > 0) {
                        this.$menu.find('.search-results').find('.active').find('a').trigger('click');
                    } else {
                        e.preventDefault();
                    }
                    break;
